// Satellite.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
#define WINTITLE	TEXT("Satellite") // 프로그램 이름
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SATELLITE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SATELLITE));
